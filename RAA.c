...
void Rational_Approximation(char* Input, mpz_t output[2])
{
    ...
    mpz_t f0,f1,g0,g1,F,G;              //初始化算法的主要迭代参数
    mpz_inits(f0,f1,g0,g1,F,G, NULL);
    mpz_set_si(f0,0);
    mpz_set_si(f1,2);
